...
/* Enable C linkage for C++ Compilers: */
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define LEDS_LED2        (1<<1)// TODO: Add mask for second board LED here

			/** LED mask for the third LED on the board. */
			#define LEDS_LED3        (1<<2)// TODO: Add mask for third board LED here

			/** LED mask for the fourth LED on the board. */
			#define LEDS_LED4        (1<<3)// TODO: Add mask for fourth board LED here
